...
from ...config import planned_cas_bounds_mps
from ..coupled import CoupledDescentPlanRequest, CoupledDescentPlanResult
from ..coupled import (
    _PlannerScale,
    ...
    *,
    ...
    for idx in np.flatnonzero(mask):
        sim_table.add_row(
            ...
            _fmt_ft(float(simulation.h_m[idx])),
            _fmt_kt(float(simulation.v_cas_mps[idx])),
            _fmt_deg(float(simulation.gamma_rad[idx])),
